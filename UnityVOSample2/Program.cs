...
using UnityVOSample2;

namespace UnityVOSample2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void ValueObjectBuilderRegisterType(Type type, string name)
            {
                ...
                var inj = new InjectionMethod("SetValueObjectBuilder", new ResolvedParameter<IValueObjectBuilder>(name));
                container.RegisterType(type, inj);

                // 下でエラーになる 引数なしのコンストラクタがないため
                var obj = container.Resolve(type, null);
            }
    ...
    {
        protected static IValueObjectBuilder _valueObjectBuilder;

        [InjectionMethod]
        public void SetValueObjectBuilder(IValueObjectBuilder valueObjectBuilder)
        {
        ...
        public static bool operator ==(ValueObject<T> vo1, ValueObject<T> vol2)
        {
            return Equals(vo1, vol2);
        }
    ...
    public class VCode1 : ValueObject<VCode1>
    {
        ...
        protected override bool EqualsCore(VCode1 other)
        {
    ...
    public class VCode2 : ValueObject<VCode2>
    {
        public string Value { get; }
        ...
        protected override bool EqualsCore(VCode2 other)
        {
            throw new NotImplementedException();
        }
